// Array to store location data
        ...
        function recordLocation() {
            ...
            if (!lastName) {
                status.textContent = 'Please enter a Last Name.';
                return;
            }

            if (!no) {
                status.textContent = 'Please select a No.';
                return;
            }
            ...
            status.textContent = `Location recorded successfully for ${name} ${lastName}! (${currentLat}, ${currentLon})`;

            // Clear form fields after successful recording
